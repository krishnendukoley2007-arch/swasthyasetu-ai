...
abstract class AppLocalizations {
  ...
  /// No description provided for @screeningNoSample.
  ///
  /// In en, this message translates to:
  /// **'Error: no health reading found. Please complete the screening first.'**
  ...
  /// No description provided for @symptomBodyPain.
  ///
  /// In en, this message translates to:
  /// **'Body pain'**
  String get symptomBodyPain;
  ...
  /// No description provided for @triageDemoMode.
  ///
  /// In en, this message translates to:
  /// **'Demo mode - simulated result'**
  String get triageDemoMode;

  /// No description provided for @triageRiskScore.
  ///
  /// In en, this message translates to:
  /// **'Risk score - 0 to 100'**
  String get triageRiskScore;

  /// No description provided for @triageScoreCaption.
  ///
  /// In en, this message translates to:
  /// **'screening score'**
  String get triageScoreCaption;

  /// No description provided for @triageEscalation.
  ///
  /// In en, this message translates to:
  /// **'Escalation:'**
  String get triageEscalation;

  /// No description provided for @triageRulesNone.
  ///
  /// In en, this message translates to:
  /// **'No risk rules triggered. All vitals are within normal screening thresholds.'**
  String get triageRulesNone;

  /// No description provided for @triageRulesTriggered.
  ///
  /// In en, this message translates to:
  /// **'Triggered rules'**
  String get triageRulesTriggered;

  /// No description provided for @triageDerivedEstimates.
  ///
  /// In en, this message translates to:
  /// **'Derived estimates'**
  String get triageDerivedEstimates;

  /// No description provided for @triageExperimental.
  ///
  /// In en, this message translates to:
  /// **'Experimental'**
  String get triageExperimental;

  /// No description provided for @triageDerivedDisclaimer.
  ///
  /// In en, this message translates to:
  /// **'Estimated from pulse timing - confirm with calibrated devices before treatment decisions.'**
  String get triageDerivedDisclaimer;

  /// No description provided for @triageReportedSymptoms.
  ///
  /// In en, this message translates to:
  /// **'Reported symptoms'**
  String get triageReportedSymptoms;

  /// No description provided for @triageSendSos.
  ///
  /// In en, this message translates to:
  /// **'Send emergency SOS'**
  String get triageSendSos;

  /// No description provided for @triageSosCancelNote.
  ///
  /// In en, this message translates to:
  /// **'You will get {seconds} seconds to cancel before anything is sent.'**
  String triageSosCancelNote(int seconds);

  /// No description provided for @triageDoctorReferral.
  ///
  /// In en, this message translates to:
  /// **'Doctor referral slip'**
  String get triageDoctorReferral;
  ...
  /// No description provided for @vitalEcgQuality.
  ///
  /// In en, this message translates to:
  /// **'ECG quality'**
  String get vitalEcgQuality;

  /// No description provided for @vitalOutOfRange.
  ///
  /// In en, this message translates to:
  /// **'Out of range'**
  String get vitalOutOfRange;

  /// No description provided for @patientWalkIn.
  ///
  /// In en, this message translates to:
  /// **'Walk-in patient'**
  String get patientWalkIn;

  /// No description provided for @triageMeasuredVitals.
  ///
  /// In en, this message translates to:
  /// **'Measured vitals'**
  String get triageMeasuredVitals;

  /// No description provided for @triageAshaGuidance.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @sosLogReadError.
  ///
  /// In en, this message translates to:
  /// **'Could not read the SOS log.'**
  String get sosLogReadError;

  /// No description provided for @sosPressSendToRecipients.
  ///
  /// In en, this message translates to:
  /// **'Press send in your messaging app to deliver it to {count} contact(s).'**
